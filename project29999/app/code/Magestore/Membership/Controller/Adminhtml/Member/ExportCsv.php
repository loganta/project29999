 ...
 */
class ExportCsv extends \Magestore\Membership\Controller\Adminhtml\Member
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_members.csv';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\Member\Grid')->getCsvFile();
