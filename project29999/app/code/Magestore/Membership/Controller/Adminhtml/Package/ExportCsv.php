 ...
 */
class ExportCsv extends \Magestore\Membership\Controller\Adminhtml\Package
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_packages.csv';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\Package\Grid')->getCsvFile();
