 ...
 */
class ExportXml extends \Magestore\Membership\Controller\Adminhtml\Package
{
    /**
     * Execute action
     */
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\Package\Grid')->getXml();
