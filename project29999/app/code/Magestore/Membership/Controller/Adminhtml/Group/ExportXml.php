 ...
 */
class ExportXml extends \Magestore\Membership\Controller\Adminhtml\Group
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_groups.xml';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\Group\Grid')->getXml();
