 ...
 */
class ExportXml extends \Magestore\Membership\Controller\Adminhtml\PaymentHistory
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_payment_history.xml';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\PaymentHistory\Grid')->getXml();
