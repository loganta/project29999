 ...
 */
class ExportCsv extends \Magestore\Membership\Controller\Adminhtml\Group
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_groups.csv';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\Group\Grid')->getCsvFile();
