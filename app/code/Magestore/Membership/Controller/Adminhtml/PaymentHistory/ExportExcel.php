 ...
 */
class ExportExcel extends \Magestore\Membership\Controller\Adminhtml\PaymentHistory
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'membership_payment_history.xls';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('MageStore\Membership\Block\Adminhtml\PaymentHistory\Grid')->getExcelFile();
